    ...
    <body>
        ...
        <center> 
            ...
            <form  method="post" id="myform" >
                ...
                <h2 id="check" hidden>Cochez <span id="numbers" style="color:red">5</span> numéros et <span id="numberchance" style="color:red">1</span> PowerBall </h2>
                <div class="box_balls">
                    <?php 
                    //nb it's the numbers of balls
                        ...
                        while($j<=26){ 
                            ...
                            ?>
                                <input type="button" id="ball2" style="color:rgb(255,120,80);border:1px solid rgb(255,120,80);" class="ball" value="<?=$j?>">
                            <?php
                            $j++;
                            if($j==6 or $j==11 or $j==16 or $j==21 or $j==26 ) echo "<br>";
                        }
                    ?>
                </div>
                <br>
        ...
        <script>
                    ...
                    $(document).on('click','#ball',function(){
                        ...
                        if(ballsnb==1 && jQuery.inArray(chanceballvalue,Tballvalues2) === -1 ){
                            this.style="color: #ffffff;background: rgb(255,120,80)";
                            ballsnb=0;
                            ...
                            this.style="color: rgb(255,120,80);border:1px solid rgb(255,120,80);background: white";
                            ballsnb=1;
                            $('#numberchance').text(ballsnb);
   ...
   //  $db=new mysqli('localhost','root','','lottodb');
    ...
    if(isset($_POST['earn'])){
        ...
        for($i=0,$j=0;$i<$nbballs,$j<$nbballs;$i++,$j++){
                ...
                echo '<br><input type="button"  class="ball" style="background:rgb(255,120,80);color:white" value="'.$userchanceball.'">';
