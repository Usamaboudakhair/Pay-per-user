    ...
    <body>
        ...
        <center> 
            ...
            <form  method="post" id="myform" >
                ...
                <h2 id="check" hidden>Cochez <span id="numbers" style="color:red">6</span></h2>
                <div class="box_balls">
                    <?php 
...
<?php
   ...
   //  $db=new mysqli('localhost','root','','lottodb');
    ...
    if(isset($_POST['earn'])){
        ...
        echo "<div style=''>";
        for($i=0;$i<$nbballs;$i++){
                    echo '<input type="button"   class="ball" style="background:#636363;color:white" value="'.$userballs[$i].'">';
        }
