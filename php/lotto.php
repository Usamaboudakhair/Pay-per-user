    ...
    <body>
        ...
        <center> 
            ...
            <form  method="post" id="myform" >
                ...
                <h2 id="check" hidden>Cochez <span id="numbers" style="color:red">5</span> numéros et <span id="numberchance" style="color:red">1</span> numéro chance </h2>
                <div class="box_balls">
                    <?php 
                    //nb it's the numbers of balls
                        ...
                        createballs(49);
                        $j=1;
                        echo "<h3><strong style='font-size:20px;color: rgb(255,100,80)'>N° Chance</strong></h3>";
                        while($j<=10){ 
                            
                            ?>
                                <input type="button" id="ball2" style="color:red" class="ball" value="<?=$j?>">
                            <?php
                            $j++;
        ...
        <script>
                    ...
                    $(document).on('click','#ball',function(){
                        ...
                        if(ballsnb==1 && jQuery.inArray(chanceballvalue,Tballvalues2) === -1 ){
                            this.style="color: #ffffff;background: rgb(255,100,80)";
                            ballsnb=0;
                            ...
                            this.style="color: red ;background: white";
                            ballsnb=1;
                            $('#numberchance').text(ballsnb);
   ...
   //  $db=new mysqli('localhost','root','','lottodb');
    ...
    if(isset($_POST['earn'])){
        ...
        for($i=0,$j=0;$i<$nbballs,$j<$nbballs;$i++,$j++){
            ...
            if($userchanceball==$randomballs[$nbballs]){
                $ch++;
             }
            if($ch>0){
                $win++;
                echo '<input type="button"  class="ball" style="background:#af2892;color:white" value="'.$userchanceball.'">';
            }else{
                echo '<input type="button"  class="ball" style="background:#af2892;color:white" value="'.$userchanceball.'">';
            }
